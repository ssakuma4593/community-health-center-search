# Community Health Center Search - GitHub Pages Deployment

This document describes the GitHub Pages deployment setup for the Vite-based frontend.
...
- Run `npm install` in `vite-frontend/`
...
See the main README for OpenAI enrichment setup instructions.
